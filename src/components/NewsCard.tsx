...
export function NewsCard({
  ...
  return (
    <a
      ...
      className={`group flex h-full w-full flex-col transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/35 focus-visible:ring-offset-2 ${
