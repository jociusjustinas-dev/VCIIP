  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          role="listbox"
          className="absolute left-0 right-0 top-full z-30 mt-2 overflow-hidden rounded-2xl border border-primary/12 bg-white p-1 shadow-[0_22px_70px_rgba(20,50,58,0.16)]"
        >
          {options.map((option) => {
