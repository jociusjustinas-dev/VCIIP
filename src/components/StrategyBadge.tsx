...
export function StrategyBadge({ active = false }: { active?: boolean }) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-0 right-8 z-[996] flex items-center gap-2 rounded-t-2xl border border-primary/14 bg-white/88 px-5 py-3 font-mono text-[0.72rem] font-semibold uppercase tracking-[0.16em] text-primary shadow-[0_18px_54px_rgba(20,50,58,0.14)] backdrop-blur-xl transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-accent hover:bg-accent max-[767px]:right-4 max-[767px]:px-4 ${
