            ...
            <div className="w-1/2 px-4 max-[767px]:w-full max-[767px]:px-0">
              <div className="reveal-item flex h-full max-w-[620px] flex-col items-start justify-between gap-16 max-[767px]:gap-10">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <a
                    href="/ekosistema/"
                    className="group inline-flex min-h-12 w-fit items-center justify-center overflow-hidden rounded-full bg-white px-5 py-3 text-base font-semibold leading-none text-primary transition hover:bg-accent"
                  >
