    ...
    >
      {marqueeItems.map((item) => (
        <div
          ...
          className="mr-5 flex h-[280px] w-[440px] flex-none snap-start flex-col justify-between overflow-hidden rounded-2xl bg-primary px-9 py-8 text-white max-[767px]:h-[240px] max-[767px]:w-[340px] max-[767px]:px-6 max-[767px]:py-6 max-[479px]:mr-3 max-[479px]:h-[220px] max-[479px]:w-[300px]"
        >
          ...
          <div className="flex items-end justify-between gap-6">
            ...
            <span className="mb-1 size-3 shrink-0 rounded-full bg-accent" />
          </div>
        </div>
      ))}
    </div>
